...
t2_dict_train_thumos_10 = {split_t2_train_thumos_10[i] : i for i in sorted(range(20))}
t2_dict_test_thumos_10 = {split_t2_test_thumos_10[i] : i for i in sorted(range(20))}
